# Teleport Lab
This lab is used to demonstrate a Kubernetes cluster with an NGINX application. Certificates are managed via Cert Manager and access is controlled through Teleport. This cluster has the following components:
